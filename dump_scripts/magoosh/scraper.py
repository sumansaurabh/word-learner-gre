...
# @Last Modified time: 2018-06-29 21:06:01
...
def scrape(url, idx):
	url="https://www.memrise.com/course/231106/magoosh-gre-vocab-with-full-audio/"+str(idx)+"/"
	html=requests.get(url)
	soup = BeautifulSoup(html.text, 'html.parser')
	...
	import json
	with open('mahattan-advanced-'+str(idx)+'.json', 'w') as outfile:
	    json.dump(_dic, outfile)
